...
export const destinations:Destination[]=[{id:'kyoto',name:'Kyoto',country:'Japan',label:'Kyoto, Japan',image:'/kyoto-diorama.png',subtitle:'Ancient lanes. Quiet temples. A thousand little discoveries.',days:kyoto,color:'#315c45'},{id:'bali',name:'Bali',country:'Indonesia',label:'Bali, Indonesia',image:'/bali-diorama.png',subtitle:'Jungle mornings. Ocean afternoons. Life at island pace.',days:bali,color:'#276c62'},{id:'alps',name:'Swiss Alps',country:'Switzerland',label:'Swiss Alps, Switzerland',image:'/alps-diorama.png',subtitle:'Wide-open skies. Alpine trails. A little closer to wonder.',days:alps,color:'#3c6380'}];
